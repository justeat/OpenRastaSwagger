...
(function() {
    ...
    g.setDomLibrary = function(a) { i = a; };
    ...
    f.extend(r.prototype, k, {
        ...
        get: function(a) { return null == a ? void 0 : this._byId[null != a.id ? a.id : a]; },
    ...
    f.each("forEach,each,map,reduce,reduceRight,find,detect,filter,select,reject,every,all,some,any,include,contains,invoke,max,min,sortBy,sortedIndex,toArray,size,first,initial,rest,last,without,indexOf,shuffle,lastIndexOf,isEmpty,groupBy".split(","), function(a) { r.prototype[a] = function() { return f[a].apply(f, [this.models].concat(f.toArray(arguments))); }; });
    ...
    g.sync = function(a, b, c) {
        ...
        if (g.emulateHTTP && ("PUT" === d || "DELETE" === d))g.emulateJSON && (e.data._method = d), e.type = "POST", e.beforeSend = function(a) { a.setRequestHeader("X-HTTP-Method-Override", d); };
    ...
    var x = function() {},
        ...
        n = function(a, b) { return!a || !a[b] ? null : f.isFunction(a[b]) ? a[b]() : a[b]; },
        t = function() { throw Error('A "url" property or function must be specified'); };
}).call(this);