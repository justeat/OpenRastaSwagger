...
(function() {
    ...
    var s = this, I = s._, o = {}, k = Array.prototype, p = Object.prototype, i = k.slice, J = k.unshift, l = p.toString, K = p.hasOwnProperty, y = k.forEach, z = k.map, A = k.reduce, B = k.reduceRight, C = k.filter, D = k.every, E = k.some, q = k.indexOf, F = k.lastIndexOf, p = Array.isArray, L = Object.keys, t = Function.prototype.bind, b = function(a) { return new m(a); };
    ...
    var G = b.some = b.any = function(a, c, d) {
        ...
        j(a, function(a, b, h) { if (e || (e = c.call(d, a, b, h)))return o; });
        return!!e;
    };
    b.include = b.contains = function(a, c) {
        ...
        return b = G(a, function(a) { return a === c; });
    };
    ...
    b.sortBy = function(a, c, d) {
        var e = b.isFunction(c) ? c : function(a) { return a[c]; };
        return b.pluck(b.map(a, function(a, b, c) { return{ value: a, criteria: e.call(d, a, b, c) }; }).sort(function(a, b) {
    ...
    b.first = b.head = b.take = function(a, b, d) { return b != null && !d ? i.call(a, 0, b) : a[0]; };
    ...
    b.defaults = function(a) {
        j(i.call(arguments, 1), function(b) { for (var d in b)a[d] == null && (a[d] = b[d]); });
        return a;
    };
    ...
    b.isArray = p || function(a) { return l.call(a) == "[object Array]"; };
    ...
    b.template = function(a, c, d) {
        ...
        a = "__p+='" + a.replace(O, function(a) { return"\\" + n[a]; }).replace(d.escape ||
    ...
    var x = function(a, c) { return c ? b(a).chain() : a; },
        M = function(a, c) {
